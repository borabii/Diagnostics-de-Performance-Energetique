...
file_path = os.path.join(current_dir, 'machine_learning/streamlit_app/output_', 'Dpe_Join_Enedis.csv')
...
file_path = os.path.join(current_dir, 'machine_learning/streamlit_app/output_', 'ordinal_encoder.pkl')
...
file_path = os.path.join(current_dir, 'machine_learning/streamlit_app/output_', 'scaler.pkl')
